...
const PlannerPage: React.FC = () => {
  ...
  const [subjects, setSubjects] = React.useState<(SubjectCard | null)[]>(
    Array(numSubjects).fill(null).map((_, index) => courseData[index] || null)
  )
    ...
    <div className="flex flex-col space-y-7">
      ...
      <header className="bg-planner-header text-white p-4 flex items-center">
        <div className="flex items-center space-x-4">
          <Image src="/unimelb.svg" alt="University of Melbourne" width={100} height={100} />
      ...
      <div className="grid grid-cols-[4fr_1fr] gap-8 pl-12 pr-8">
        {/* Planner Grid */}
        <div className={`grid grid-cols-4 grid-rows-${numRows} gap-4`}>
